 ...
 * This prevents multiple connections from being created during hot reloads in development.
 */
 ...
 * 
 * @returns {Promise<mongoose.Connection>} The cached or new MongoDB connection
 * 
 * The function ensures a single connection is reused across multiple calls:
 * - In production: Creates one connection and reuses it
 * - In development: Prevents hot-reload from creating duplicate connections
 */
